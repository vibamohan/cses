...
public class TwoKnights {
  public static void main(String[] args) {
    ...
    // Visualize the board, you have n^2 options to place the first knight, and n^2 - 1 for the
    // other
    // Following this, we have the attackways where since a knight moves 1 in one direction, and 2
    // in the other
